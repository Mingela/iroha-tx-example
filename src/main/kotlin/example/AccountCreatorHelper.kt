...
object AccountCreatorHelper {
    ...
    private const val timeOffset = 1000L
    private val txList = mutableListOf<TransactionOuterClass.Transaction>()
    ...
    fun getRolesTransactions(mortalAccount: String): List<TransactionOuterClass.Transaction> {
        ...
        txList.add(
            TransactionBuilder(GenesisBlockBuilder.defaultAccountId, time)
                .setQuorum(1)
        ...
        txList.add(
            TransactionBuilder(fullAccountName, time)
                .setQuorum(1)
    ...
    fun getBatchTransactions(mortalAccount: String): MutableList<TransactionOuterClass.Transaction> {
        var time = System.currentTimeMillis() - timeOffset * 20
        val fullAccountName = "$mortalAccount@soramitsu"
        val newKeypair = Ed25519Sha3().generateKeypair()
